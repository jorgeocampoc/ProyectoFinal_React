...
import { NavListMarvel } from "./NavListMarvel";
...
export const Header = () => {
  return (
    <>
      ...
      <input className="form-control m-auto form-control-sm " style={{fontSize:'12px', padding:'5px', width:'50%'}}  type="search" placeholder="Search" aria-label="Search"/>
      </div> */}
      </div>
      <NavListMarvel />
    </>
